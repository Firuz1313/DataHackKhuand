  ...
  <header class="bg-white border-b border-gray-200 px-6 py-4 ml-64">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4">
        ...
        <!-- Notifications -->
        <button
          class="relative p-2 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-lg"
        >
          <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M15 17h5l-5 5v-5zM11 19H7a2 2 0 01-2-2V7a2 2 0 012-2h4m4 0V3a2 2 0 00-2-2H9a2 2 0 00-2 2v2m0 0V3a2 2 0 012-2h4a2 2 0 012 2v2"
            />
          </svg>
        ...
        <div
          class="flex items-center space-x-2 px-3 py-2 bg-success-50 rounded-lg border border-success-200"
        >
        ...
        <div class="relative" @click="toggleUserMenu">
          <button
            class="flex items-center space-x-3 text-sm bg-white rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 p-2"
          >
