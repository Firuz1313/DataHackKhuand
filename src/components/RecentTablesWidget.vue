        ...
        <div class="space-y-4">
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <div class="mt-1 p-2 bg-gray-50 rounded border font-mono">
                {{ selectedTable.name }}
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div class="mt-1">
                <span
                  :class="getStatusBadgeClass(selectedTable.status)"
                  class="px-2 py-1 rounded-full text-xs font-medium"
                >
          ...
          <div class="flex space-x-3 pt-4">
            <button @click="queryTable" class="btn-primary">🔍 Просмотреть данные</button>
...
const queryTable = () => {
  if (selectedTable.value) {
    ...
    alert(
      `Функция просмотра данных будет реализована в следующей версии.\n\nЗапрос: SELECT * FROM ${selectedTable.value.name} LIMIT 100`,
    )
    closeModal()
  }
}
