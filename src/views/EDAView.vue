<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="ml-64">
      ...
      <main class="p-6">
        <div class="mb-6">
          <h1 class="text-2xl font-bold text-gray-900 mb-2">EDA - Исследовательский анализ данных</h1>
          <p class="text-gray-600">Профессиональный анализ структуры, качества и паттернов в ваших данных</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div class="bg-white rounded-lg shadow-card border border-gray-200 p-6">
            <div class="flex items-center">
              ...
              <div>
                <div class="text-2xl font-bold text-gray-900">{{ edaMetrics.dataQualityScore }}%</div>
        ...
        <div class="bg-white rounded-lg shadow-card border border-gray-200 p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div
              ...
              :class="selectedTable === table.name ? 'ring-2 ring-primary-500 bg-primary-50' : 'hover:bg-gray-50'"
            ...
            >
              <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded">{{ table.records }} записей</span>
              </div>
        ...
        <div v-if="selectedTable && profileData" class="space-y-6">
          ...
          <div class="bg-white rounded-lg shadow-card border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
              <h2 class="text-lg font-semibold text-gray-900">Профилирование столбцов: {{ selectedTable }}</h2>
            </div>
              ...
              <div class="overflow-x-auto">
                <table class="w-full">
                  <thead class="bg-gray-50">
                    <tr>
                      <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Столбец</th>
                      ...
                      <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Уникальные</th>
                      <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Качество</th>
                      <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Распределение</th>
                    </tr>
                  </thead>
                  <tbody class="divide-y divide-gray-200">
                    <tr v-for="column in profileData.columns" :key="column.name" class="hover:bg-gray-50">
                      <td class="px-4 py-3">
                        ...
                        <div class="flex items-center">
                          <div class="flex-1 bg-gray-200 rounded-full h-2 mr-2">
                            <div 
                              ...
                              :class="column.nullPercent > 50 ? 'bg-error-500' : column.nullPercent > 20 ? 'bg-warning-500' : 'bg-success-500'"
                      ...
                      <td class="px-4 py-3">
                        <div class="text-sm text-gray-900">{{ column.uniqueValues.toLocaleString() }}</div>
                        <div class="text-xs text-gray-500">{{ column.uniquePercent }}% уникальных</div>
                      </td>
                      <td class="px-4 py-3">
                        <div class="flex items-center">
                          <div 
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <div class="flex items-center justify-between">
                    <span class="text-xs text-gray-500">{{ issue.affectedRows }} строк затронуто</span>
                    <span 
                      :class="getSeverityTextColor(issue.severity)"
                ...
                >
                  ...
                  <div class="flex-1">
                    ...
                    <div class="flex items-center">
                      ...
                      <span class="text-xs text-gray-500">Confidence: {{ insight.confidence }}%</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="p-6">
              <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="space-y-4">
                  ...
                  <div class="space-y-2">
                    <div class="flex justify-between">
                      ...
                      <span class="text-sm font-medium">{{ profileData.totalRows.toLocaleString() }}</span>
                    </div>
                    <div class="flex justify-between">
                ...
                <div class="space-y-4">
                  ...
                  <div class="space-y-2">
                    <div v-for="(count, type) in profileData.dataTypes" :key="type" class="flex justify-between">
        ...
        <div v-else class="bg-white rounded-lg shadow-card border border-gray-200 p-12 text-center">
          ...
          <p class="text-gray-600 mb-4">Выберите таблицу выше, чтобы начать исследовательский анализ данных</p>
        </div>
      </main>
    </div>
  </div>
...
const autoInsights = ref([
  {
    ...
    description: 'Обнаружена сильная сезонная составляющая в активности пользователей с пиком в декабре',
  ...
  },
  {
    ...
    description: 'Сильная положительная корреляция (r=0.74) между возрастом пользователей и их доходом',
...
const generateMockColumns = (count: number) => {
  ...
  const names = ['id', 'user_id', 'email', 'name', 'created_at', 'updated_at', 'status', 'amount', 'description', 'category']
