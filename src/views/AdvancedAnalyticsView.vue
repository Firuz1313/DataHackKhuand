      ...
      <div class="px-6 py-4">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Comprehensive Business Intelligence Dashboard</p>
          </div>
      ...
      <div v-else class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div v-else class="text-center py-4 text-gray-500">Данные по каналам не найдены</div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div v-if="kpis?.geography?.regions?.length > 0" class="space-y-3">
              ...
              >
                <div class="flex items-center">
                  <span
                    class="w-6 h-6 rounded-full bg-primary-100 text-primary-600 text-xs font-bold flex items-center justify-center mr-3"
                  >
                    {{ index + 1 }}
                  </span>
                  <div>
            ...
            <div v-else class="text-center py-4 text-gray-500">Данные по регионам не найдены</div>
          </div>
        ...
        >
          <h3 class="text-lg font-semibold text-gray-900 mb-4">📊 Бизнес-инсайты и рекомендации</h3>
          <div class="space-y-4">
            <div
        ...
        <div
          v-if="kpis?.seasonality?.daily_patterns?.length > 0"
          class="bg-white rounded-lg shadow-sm border border-gray-200 p-6"
        >
...
const getInsightBadgeText = (impact: string): string => {
  switch (impact) {
    case 'high':
      return 'Высокий импакт'
    case 'medium':
      return 'Средний импакт'
    case 'low':
      return 'Низкий импакт'
    default:
      return 'Неизвестно'
  }
}
