      ...
      <main class="p-6">
        ...
        <div class="bg-white rounded-lg shadow-card border border-gray-200 p-6 mb-6">
          ...
          <div class="space-y-6">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Количество строк на странице</label>
              <select
        ...
        <div class="bg-white rounded-lg shadow-card border border-gray-200 p-6 mb-6">
          ...
          <div class="space-y-6">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Максимальное время выполнения (секунды)</label>
              <input
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Максимальное количество результатов</label>
              <input
            ...
            <div class="flex items-center justify-between">
              <div>
                <label class="block text-sm font-medium text-gray-900">Автоформатирование SQL</label>
                <p class="text-sm text-gray-600">Автоматически форматировать SQL запросы</p>
              </div>
              <label class="relative inline-flex items-center cursor-pointer">
                <input
                  v-model="querySettings.autoFormat"
                  type="checkbox"
                  class="sr-only peer"
                />
                <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
        ...
        <div class="bg-white rounded-lg shadow-card border border-gray-200 p-6">
          ...
          <div class="flex space-x-4">
            ...
            <label class="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors duration-200 cursor-pointer">
              📤 Импорт настроек
              <input
                type="file"
